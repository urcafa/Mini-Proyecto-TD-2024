...
ficheros <- list.files(path = carpeta, full.names = TRUE, recursive = TRUE, pattern = ".txt")
for (fichero in ficheros){
    # Leer el archivo txt
  ticket <- read.table(fichero, header = TRUE, stringsAsFactors = FALSE, sep = "\t")
  # Agregar el dataframe del ticket a la lista
  lista[[length(lista) + 1]] <- ticket
}

# Combinar todos los dataframes en uno solo
df_tickets <- do.call(rbind, lista)
